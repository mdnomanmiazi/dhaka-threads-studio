...
const Denim = () => {
  ...
  return (
    <>
      ...
      <ProductCategorySlider slides={featuredSlides} category="Denim" />
            ...
            <div className="mx-4">
              <div className="w-12 h-12 rounded-full bg-navy flex items-center justify-center animate-pulse">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-white">
                  ...
                  <rect width="6" height="16" x="14" y="4" rx="2"></rect>
                </svg>
              </div>
            </div>
            <div className="h-px bg-gray-200 w-1/3"></div>
      ...
      <section className="section-padding bg-white relative">
        ...
        <div className="absolute inset-0 pointer-events-none opacity-5">
          <div className="absolute inset-0" 
            style={{ 
              backgroundImage: 'repeating-linear-gradient(-45deg, #d4af37 0, #d4af37 1px, transparent 0, transparent 10px)',
          ...
          <div className="bg-navy text-white rounded-lg p-8 md:p-12 flex flex-col md:flex-row justify-between items-center animate-on-scroll relative overflow-hidden">
            ...
            <div className="absolute inset-0 pointer-events-none opacity-10">
              <div className="w-full h-full" style={{ 
                backgroundImage: 'repeating-linear-gradient(0deg, #d4af37, #d4af37 2px, transparent 2px, transparent 10px)',
